...
public class FamilyTreeView2 extends ViewGroup {
    ...
    private final int mItemHeightDP = 90;//家庭成员View高度90dp
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (mMineView != null) {
            ...
            if (mFatherView != null) {
                ...
                int fatherTop = mineTop - mItemHeightPX - mSpacePX;

                if (mMotherView != null) {
                    fatherLeft -= mItemWidthPX + mSpacePX;
                }

                setChildFrame(mFatherView, fatherLeft, fatherTop, mItemWidthPX, mItemHeightPX);

                if (mPaternalGrandFatherView != null) {
                    int grandFatherLeft = fatherLeft;

                    if (mPaternalGrandMotherView != null) {
                        grandFatherLeft -= mItemWidthPX;
                    }

                    setChildFrame(mPaternalGrandFatherView,
                            grandFatherLeft, fatherTop - mItemHeightPX - mSpacePX,
                            mItemWidthPX, mItemHeightPX);
                }
                ...
                if (mPaternalGrandMotherView != null) {
                    ...
                    if (mPaternalGrandFatherView != null) {
                        grandMotherLeft += mItemWidthPX;
                    }

                    setChildFrame(mPaternalGrandMotherView,
                            grandMotherLeft, fatherTop - mItemHeightPX - mSpacePX,
                            mItemWidthPX, mItemHeightPX);
                }
            }
            ...
            if (mMotherView != null) {
                ...
                int motherTop = mineTop - mItemHeightPX - mSpacePX;

                if (mFatherView != null) {
                    motherLeft += mItemWidthPX + mSpacePX;
                }

                setChildFrame(mMotherView, motherLeft, motherTop, mItemWidthPX, mItemHeightPX);
                ...
                if (mMaternalGrandFatherView != null) {
                    ...
                    setChildFrame(mMaternalGrandFatherView,
                            grandFatherLeft, motherTop - mItemHeightPX - mSpacePX,
                            mItemWidthPX, mItemHeightPX);
                }
                ...
                if (mMaternalGrandMotherView != null) {
                    ...
                    setChildFrame(mMaternalGrandMotherView,
                            grandMotherLeft, motherTop - mItemHeightPX - mSpacePX,
                            mItemWidthPX, mItemHeightPX);
                }
            }
...
//        super.onDraw(canvas);
    ...
    private void drawParentLine(Canvas canvas) {
        if (mFatherView != null || mMotherView != null) {
            ...
            int verticalLineStartY = mineY - mSpacePX - mItemHeightPX + mItemWidthPX / 2;
            mPath.reset();
            ...
            if (mFatherView != null && mMotherView != null) {
                int horizontalLineStartX = (int) mFatherView.getX() + mItemWidthPX;
                int horizontalLineStopX = (int) mMotherView.getX();
                int horizontalLineY = (int) mFatherView.getY() + mItemWidthPX / 2;
                mPath.reset();
                mPath.moveTo(horizontalLineStartX, horizontalLineY);
                mPath.lineTo(horizontalLineStopX, horizontalLineY);
                canvas.drawPath(mPath, mPaint);
        ...
        if (mFatherView != null) {
            if (mPaternalGrandFatherView != null || mPaternalGrandMotherView != null) {
                ...
                int verticalLineX = fatherX + mItemWidthPX / 2;
                int verticalLineStartY = fatherY - mSpacePX - mItemHeightPX + mItemWidthPX / 2;
                mPath.reset();
                mPath.moveTo(verticalLineX, verticalLineStartY);
                ...
                if (mPaternalGrandFatherView != null && mPaternalGrandMotherView != null) {
                    int horizontalLineStartX = (int) mPaternalGrandFatherView.getX() + mItemWidthPX;
                    int horizontalLineStopX = (int) mPaternalGrandMotherView.getX();
                    int horizontalLineY = (int) mPaternalGrandFatherView.getY() + mItemWidthPX / 2;
                    mPath.reset();
                    mPath.moveTo(horizontalLineStartX, horizontalLineY);
                    mPath.lineTo(horizontalLineStopX, horizontalLineY);
                    canvas.drawPath(mPath, mPaint);
        ...
        if (mMotherView != null) {
            if (mMaternalGrandFatherView != null || mMaternalGrandMotherView != null) {
                ...
                int verticalLineX = motherX + mItemWidthPX / 2;
                int verticalLineStartY = motherY - mSpacePX - mItemHeightPX + mItemWidthPX / 2;
                mPath.reset();
                mPath.moveTo(verticalLineX, verticalLineStartY);
                ...
                if (mMaternalGrandFatherView != null && mMaternalGrandMotherView != null) {
                    int horizontalLineStartX = (int) mMaternalGrandFatherView.getX() + mItemWidthPX;
                    int horizontalLineStopX = (int) mMaternalGrandMotherView.getX();
                    int horizontalLineY = (int) mMaternalGrandFatherView.getY() + mItemWidthPX / 2;
